...
<body>
  ...
  if(msg != null)
  {
  	if(msg.equals("valid")){
  		%>
  		<center><font color="red" size="5">Form Submitted, you will get reesponse soon</font></center>
  		...
  		%>
  		<center><font color="red" size="5">Form NOT Submitted, Invalid Data</font></center>
 ...
 <center>
 	...
 	<input type = "text" name = "bloodGroup" placeholder = "Required Blood Group" required>
